...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{../plots/scatter_val_f1.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{../plots/perf_vs_layers_dims.png}
...
\begin{figure}[h!]
  \includegraphics[width=0.48\textwidth]{../plots/pos_vs_neg.png}
...
\begin{figure*}[b]
  \centering
  \includegraphics[width=\textwidth]{../plots/training_curve.png}
